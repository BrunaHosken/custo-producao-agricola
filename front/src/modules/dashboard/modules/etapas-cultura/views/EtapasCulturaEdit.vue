    ...
    formEditou(pValue) {
      ...
      if (pValue && pValue.length > 0) {
        this.form = {
          ...
          mesInicio: pValue[0].mesInicio,
          mesFinal: pValue[0].mesFinal,
          datePrevista: pValue[0].datePrevista,
          descricao: pValue[0].descricao,
        ...
        this.dateDialogValueInitial = pValue[0].mesInicio;
        this.dateDialogValuePrevista = pValue[0].datePrevista;
        this.dateDialogValueFinal = pValue[0].mesFinal;
      }
    },
